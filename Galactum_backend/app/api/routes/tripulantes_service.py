# app/v2_features_beta/services/tripulantes_service.py
from sqlalchemy.orm import Session
from ...v2_features_beta.models.costos_tripulantes import TripulanteCostoContratar, TripulanteCostoMejora # type: ignore
